...
async function main() {
  ...
  const products = [
    ...
    },
    {
      ...
      stock: 3,
      isActive: true,
      images: ['/products/s19-pro-110th.png'],
      hashrate: '110 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 4,
      isActive: true,
      images: ['/products/s19-pro-105th.jpg'],
      hashrate: '105 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 5,
      isActive: true,
      images: ['/products/s19j-pro-100th.png'],
      hashrate: '100 TH/s',
      algorithm: 'SHA-256',

...
async function main() {
  ...
  const products = [
    // New Miners
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/s21_grande.jpg?v=1704125924'],
      hashrate: '200 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/s21_af353431-9320-405a-b876-b6124b2497cb_grande.jpg?v=1704126052'],
      hashrate: '190 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/pwn4tjii4lr7pdwf7s5d_1_0b1c8389-b92e-4809-bc1f-75dbd664cbf3_grande.png?v=1640640222'],
      hashrate: '140 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 6,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/s19jproplus120th_grande.png?v=1689675531'],
      hashrate: '120 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/T17_97fcbcf2-0b16-491c-bb24-8a3069245927_grande.jpg?v=1705656830'],
      hashrate: '120 TH/s',
      algorithm: 'SHA-256',
      powerConsumption: '2760W',
    ...
    },
    {
      ...
      stock: 5,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/T17_25fad657-9ef7-454b-9d30-af87461b353b_grande.jpg?v=1705656946'],
      hashrate: '115 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 3,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/ksue7vcayg9m2ttyph7m_a3225578-a37c-4498-9040-ec7ae9ac9e88_grande.png?v=1640780938'],
      hashrate: '110 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 4,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/T17_grande.jpg?v=1666767293'],
      hashrate: '105 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 2,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/pwn4tjii4lr7pdwf7s5d_1_grande.png?v=1640615814'],
      hashrate: '104 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 5,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/pwn4tjii4lr7pdwf7s5d_grande.png?v=1640615187'],
      hashrate: '100 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 3,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/untitled-design-9--500x500_7e3dcb86-c3bb-45cd-9dd6-3527c1a5c516_grande.png?v=1627287558'],
      hashrate: '110 TH/s',
      algorithm: 'SHA-256',
      powerConsumption: '3250W',
    ...
    },
    {
      ...
      stock: 6,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/ksue7vcayg9m2ttyph7m_6c717f41-58ed-475d-9618-f26dceac386f_grande.png?v=1640779556'],
      hashrate: '95 TH/s',
      algorithm: 'SHA-256',
      powerConsumption: '3250W',
    ...
    },
    {
      ...
      stock: 4,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/pwn4tjii4lr7pdwf7s5d_b0d0d8e5-ee88-4174-9baa-1c108525f932_grande.png?v=1640617089'],
      hashrate: '90 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/files/KASminerks3_8426fe2d-8ad3-46d3-b45e-01b90a14fa0d_grande.jpg?v=1716878566'],
      hashrate: '21 TH/s',
    ...
    },
    {
      ...
      stock: 2,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/pwn4tjii4lr7pdwf7s5d_1_d4cef630-6881-4a5b-b1ad-5c2c9c9e9fbb_grande.png?v=1640640622'],
      hashrate: '16 GH/s',
      algorithm: 'Scrypt',
    ...
    },
    {
      ...
      stock: 3,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/Screenshot2022-10-27104159_grande.png?v=1667244418'],
      hashrate: '14 GH/s',
      algorithm: 'Scrypt',
    ...
    // Whatsminer products
    {
      ...
      isActive: true,
      isFeatured: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/whatsminerm21s_7f2c7f5a-a3cc-40ff-9f11-dbd030102cb3_grande.png?v=1665218700'],
      hashrate: '298 TH/s',
      algorithm: 'SHA-256',
    ...
    // Second Hand Miners
    {
      ...
      stock: 2,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/whatsminerm21s_2a39174d-2ec8-42e2-9a94-5243d78cca03_grande.png?v=1665219134'],
      hashrate: '130 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 3,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/whatsminerm21s_34ed1992-3a6d-46c6-8050-c8d7d40b4ca7_grande.png?v=1665218975'],
      hashrate: '124 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 4,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/ibwieepotfwl6zdy0yka_aa9f13f0-82c6-4721-b6ff-e378dbf83a22_grande.png?v=1640715409'],
      hashrate: '88 TH/s',
      algorithm: 'SHA-256',
    ...
    },
    {
      ...
      stock: 5,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/ibwieepotfwl6zdy0yka_95812dfe-8cd4-473b-9334-9d14859d4b61_grande.png?v=1664462840'],
      hashrate: '88 TH/s',
      algorithm: 'SHA-256',
      powerConsumption: '3344W',
    ...
    // Accessories
    {
      ...
      stock: 10,
      isActive: true,
      images: ['https://shopcrypto.co.za/cdn/shop/products/WhatsAppImage2022-05-18at8.44.50AM_1_grande.jpg?v=1652856374'],

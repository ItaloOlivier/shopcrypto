...
async function main() {
  ...
  const products = [
    ...
    // Solo Luck Miners - Trending Entry Level
    {
      name: 'Bitaxe Gamma 601 Solo Miner',
      slug: 'bitaxe-gamma-601-solo-miner',
      price: 5499,
      compareAtPrice: 6500,
      vendor: 'Bitaxe',
      categoryId: newMiners.id,
      ...
      description: 'Open-source solo Bitcoin miner. Ultra-low power consumption. Perfect for lottery mining and Bitcoin education.',
    },
    {
      name: 'Nerdminer V2 Pro',
      slug: 'nerdminer-v2-pro',
      price: 1599,
      compareAtPrice: 2000,
      vendor: 'Nerdminer',
      categoryId: newMiners.id,
      stock: 20,
      isActive: true,
      images: ['/products/nerdminer.png'],
      hashrate: '78 KH/s',
      algorithm: 'SHA-256',
      powerConsumption: '2W',
      description: 'Popular lottery Bitcoin miner. Educational device that teaches Bitcoin mining fundamentals. Great gift for crypto enthusiasts.',
    },
    {
      name: 'Nerdminer V2 Pico',
      slug: 'nerdminer-v2-pico',
      price: 1299,
      compareAtPrice: 1600,
      vendor: 'Nerdminer',
      categoryId: newMiners.id,
      ...
      algorithm: 'SHA-256',
      powerConsumption: '1W',
      description: 'Compact lottery miner with built-in display. Fun way to learn about Bitcoin mining. USB powered.',
    },
    {
      name: 'Lucky Miner LV07 Solo',
      slug: 'lucky-miner-lv07-solo',
      price: 5499,
      compareAtPrice: 6800,
      vendor: 'Lucky Miner',
      categoryId: newMiners.id,
      ...
      description: 'Efficient solo Bitcoin miner with touch screen display. Low noise, low power consumption.',
    },
    // Accessories
    {
      name: 'AC Infinity Cloudline PRO T8',
      slug: 'ac-infinity-cloudline-pro-t8',
      price: 6149,
      compareAtPrice: 7500,
      vendor: 'AC Infinity',
      ...
      stock: 8,
      isActive: true,
      images: ['/products/ac-infinity-t8.png'],
      description: 'Professional 8-inch inline fan with smart controller. Ideal for mining room ventilation and cooling. Quiet operation with variable speed control.',
    },
    {
      name: '1200W Server Power Supply',
      slug: '1200w-server-power-supply',
      price: 4999,
      compareAtPrice: 6000,
      vendor: 'Generic',
      categoryId: accessories.id,
      ...
      description: 'High-efficiency 1200W server PSU. 94% efficiency rating. Compatible with most ASIC miners. Includes breakout board.',
    },
    {
